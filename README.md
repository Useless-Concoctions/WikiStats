...
- **Reading Analytics**: Instant tracking of articles explored, session duration, and discovery metrics.
- **Smart Sidebar**: A sleek, integrated interface providing real-time stats and effortless navigation.
- **Path Mapping**: Visualize the exact lineage and connections between your explored topics.
- **Local Control**: Purely local processing ensuring your reading habits remain entirely private.

## Stack

- **AI**: Wikipedia MediaWiki API
